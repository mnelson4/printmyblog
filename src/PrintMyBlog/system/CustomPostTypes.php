...
class CustomPostTypes
{
    ...
    public function register()
    {
        ...
        $labels = array(
            ...
            'not_found'             => __('No books found.', 'print-my-blog'),
            'not_found_in_trash'    => __('No books found in Trash.', 'print-my-blog'),
            ...
            'insert_into_item'      => _x('Insert into book', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'print-my-blog'),
            'uploaded_to_this_item' => _x('Uploaded to this book', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'print-my-blog'),
            'filter_items_list'     => _x('Filter books list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'print-my-blog'),
