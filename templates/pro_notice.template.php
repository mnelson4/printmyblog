 ...
 */
?>
<div class="notice notice-info pmb-pro-notice">
    ...
    <div class="content">
        ...
        <form method="POST" action="<?php echo esc_url( "//" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']);?>">
        ...
        <button class="button button-primary">Sign Me Up!</button>
            <a href="<?php
echo add_query_arg(
    [
...
?>" class="button button-secondary">No thanks, but Good Luck!</a>
        </form>
