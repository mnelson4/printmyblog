...
<ul class="pmb-list">
    ...
    <li><?php esc_html_e('External hyperlinks (links to web pages not in the project) can be automatically converted to footnotes, left in-place, or removed', 'print-my-blog'); ?><?php pmb_pro_best_e(__('Footnotes only work with Pro', 'print-my-blog'));?></li>
    <li><?php esc_html_e('Internal hyperlinks (links to content included in the project) can be automatically converted to to footnotes, inline page references, left in-place, or removed', 'print-my-blog');?><?php pmb_pro_best_e(__('Footnotes and page references only work with Pro', 'print-my-blog'));?></li>
    ...
    <li><?php esc_html_e('Optionally float images to the top or bottom of each page', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
</ul>
