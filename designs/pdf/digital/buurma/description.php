...
<ul class="pmb-list">
    ...
    <li><?php esc_html_e('All hyperlinks converted into footnotes', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
...
<ul class="pmb-list">
    <li><?php esc_html_e('The default title page includes a stylized banner (with customizable color) above a colored background featuring a large version of your company logo.', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
    <li><?php esc_html_e('Main matter pages fade from white to a color of your choosing in the corner where your logo and page number are shown.', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
    <li><?php esc_html_e('Page numbers in bottom-right corner, and article titles in the top-right. Front-matter’s pages are numbered with Roman numerals', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
    <li><?php esc_html_e('Each article begins on a new page', 'print-my-blog');?></li>
    <li><?php esc_html_e('Back matter uses your large company logo with background color', 'print-my-blog');?><?php pmb_pro_only_e();?></li>
</ul>