jQuery(document).ready(function(){
    ...
    pmb_replace_internal_links_with_page_refs_and_footnotes('footnote', 'footnote_ref', pmb_design_options['external_footnote_text'], pmb_design_options['internal_footnote_text']);
    new PmbToc();
