...
<ul class="pmb-list">
    <li><?php esc_html_e('"Title page" is actually a special header on the front page containing your publication\'s title, issue number, date, and other optional prominent info (set on the design and project meta settings.', 'print-my-blog');?></li>
    ...
    <li><?php esc_html_e('The top margin contains the front page (publication title, issue number, date, etc.).', 'print-my-blog');?></li>
    ...
    <li><?php
        ...
        ?></li>
    <li><?php esc_html_e('If your content is already divided into columns, optionally automatically remove them to improve the layout.', 'print-my-blog'); ?>7</li>
    <li><?php
        esc_html_e(
...
<p><?php esc_html_e('"wide width" images take up 2 columns and snap to the nearest page edge.','print-my-blog'); ?></p>